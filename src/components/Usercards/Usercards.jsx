      ...
      ? [
          {
            ...
            gradient: "linear-gradient(82.59deg, #00c48c 0%, #00a173 100%)",
          },
          {
            title: "Total Books",
            count: dashboardData.total_books || "0",
            gradient: "linear-gradient(81.67deg, #0084f4 0%, #1a4da2 100%)",
          },
          {
            title: "Different Books",
            count: dashboardData.total_different_books || "0",
            gradient: "linear-gradient(69.83deg, #0084f4 0%, #00c48c 100%)",
          },
          {
